<template>
    <div class="max-w-[800px] mx-auto p-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 text-lg py-2">
        <div>
          <strong class="font-bold">Категория:</strong> {{ meal.strCategory }}
        </div>
        <div>
          <strong class="font-bold">Страна:</strong> {{ meal.strArea }}
        </div>
        <div>
          <strong class="font-bold">Тег:</strong> {{ meal.strTags }}
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2">
        ...
        <div>
          <h2 class="text-2xl font-semibold mb-2">Необходимый объем</h2>
          <ul>
            <template v-for="(el, ind) of new Array(20)">
